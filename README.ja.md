...
最新レビュー:
- [`docs/reviews/2026-07-01-tier1-3-document-density-alpha-min-1-dqr.md`](docs/reviews/2026-07-01-tier1-3-document-density-alpha-min-1-dqr.md) — Tier 1 #3 文書密度 α-min-1: **1/4 軸 PASS** (silent_no_op 17/17 PASS; structural/jp_language/clinical は ModuleAuditSpec API deferral による N/A)。DocumentReference 0 → 23,760 (US) / 3,909 (JP); Composition 0 → 9,275 / 474; ClinicalImpression 0 → 23,760 / 3,909。AllergyIntolerance SNOMED 8-field スキーマ upgrade、baseline 15.3% → 15.0% (±0.05 許容内)。[AD-63] — [マスタープラン](docs/design-notes/2026-06-30-tier1-document-and-event-density-master-plan.md) 参照
