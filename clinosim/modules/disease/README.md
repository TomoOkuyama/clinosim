...
├── __init__.py
├── protocol.py          # DiseaseProtocol (Pydantic, extra="forbid" AD-69) + load_disease_protocol()
├── severity.py          # ★ 重症度 sampling の owner (AD-67): sample_severity /
│                        #   sample_severity_category / category_from_score /
│                        #   SEVERITY_SCORE_RANGES + _validate_severity_block。
│                        #   population / inpatient / emergency が消費。
├── README.md
├── SPEC.md
