...
def assign_primary_nurse(
    encounter: Any, roster: StaffRoster, rng: np.random.Generator
) -> str:
    ...
    Args:
        ...
        roster: StaffRoster with members; filters by role="nurse"
        rng: per-encounter seeded RNG (derive_sub_seed caller's responsibility)

    Returns:
        staff_id of the assigned nurse, or "" if no nurses in roster.
    """
