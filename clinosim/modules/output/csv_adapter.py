...
def convert_cif_to_csv(
    ...
    for record in reader.iter_patients():
            ...
            vitals_rows.append(
                {
                    ...
                    "consciousness_level": vs.get("consciousness_level"),
                    "on_supplemental_oxygen": vs.get("on_supplemental_oxygen"),
                    "oxygen_flow_rate_lpm": vs.get("oxygen_flow_rate_lpm"),
        ...
        for mb in record.get("microbiology", []):
            ...
            if susceptibilities:
                for s in susceptibilities:
                    abx_code, abx_code_system = resolve_susceptibility_code(s.get("antibiotic_loinc", ""), country)
        ...
        if cl:
            cl_rows.append({"patient_id": patient_id, "code": cl, "display": get_display("jp-care-level", cl, country)})
