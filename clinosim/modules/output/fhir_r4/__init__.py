...
``clinosim/modules/output/fhir_r4_adapter.py`` for backward-compat with
pre-migration import paths (100+ caller sites); new code should import
directly from ``clinosim.modules.output.fhir_r4``.
"""
