...
from clinosim.modules.output.fhir_r4.localization import localize_fixed_label
from clinosim.modules.output.fhir_r4.common import BundleContext, _micro_coding, build_presented_form
...
def _bb_microbiology(ctx: BundleContext) -> list[dict]:
    ...
    for i, mb in enumerate(cultures):
        ...
        if not report.get("issued") and mb.get("reported_datetime"):
            from clinosim.modules.output.fhir_r4.common import to_fhir_instant
