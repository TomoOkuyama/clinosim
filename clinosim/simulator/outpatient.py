...
def _simulate_outpatient_visit(
    ...
    # Phase 2b (2026-06-24): medication flags merged. Outpatient = chronic-
    # context only — medication_orders=None / current_day=None so only the
    # chronic warfarin detection runs (post-PE/DVT/embolic-CI on chronic AC).
    _flags = {
