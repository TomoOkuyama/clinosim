...
def report_for_country(country: str, master_dir: Path, branch_dir: Path, out_lines: list[str]) -> None:
    ...
    out_lines.append(
        "Pre-J5: ED-presentation MI patients hit only the type-2 branch "
...
def main() -> int:
    ...
    for country in ("US", "JP"):
        report_for_country(country, master_root / country.lower(), branch_root / country.lower(), out_lines)
