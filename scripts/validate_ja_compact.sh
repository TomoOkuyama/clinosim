#!/usr/bin/env bash
# Compact JP narrative test: 8 patients, all 5 document types, ~22 docs
set -euo pipefail

CIF_DIR="test_data/jp_compact"
VERSION_ID="bedrock_ja_compact"
LLM_CONFIG="clinosim/config/llm_service.bedrock.yaml"
RESULT_FILE="test_data/bedrock_ja_compact_results.txt"

{
echo "============================================================"
echo "  JP Compact Narrative Test (8 patients, 5 types)"
...
echo "  git add ${RESULT_FILE} && git commit -m 'ja compact results' && git push"
echo "============================================================"
} 2>&1 | tee "${RESULT_FILE}"
