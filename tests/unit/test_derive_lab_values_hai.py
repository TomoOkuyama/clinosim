...
def test_baseline_with_clabsi_full_lift():
    labs = derive_lab_values(_state(0.4), sex="M", age=60, hour=10, hai_inflammation_lift=0.35)
...
def test_baseline_with_cauti_full_lift():
    labs = derive_lab_values(_state(0.4), sex="M", age=60, hour=10, hai_inflammation_lift=0.20)
...
def test_baseline_with_mid_ramp_clabsi():
    labs = derive_lab_values(_state(0.4), sex="M", age=60, hour=10, hai_inflammation_lift=0.175)
...
def test_clamp_at_high_infl_plus_max_lift():
    labs = derive_lab_values(_state(0.8), sex="M", age=60, hour=10, hai_inflammation_lift=0.35)
...
def test_high_infl_no_lift_for_comparison():
    labs = derive_lab_values(_state(0.95), sex="M", age=60, hour=10, hai_inflammation_lift=0.0)
...
def test_high_infl_with_lift_descending_leg():
    ...
    labs = derive_lab_values(_state(0.95), sex="M", age=60, hour=10, hai_inflammation_lift=0.35)
...
def test_zero_infl_with_clabsi_lift():
    labs = derive_lab_values(_state(0.0), sex="M", age=60, hour=10, hai_inflammation_lift=0.35)
...
def test_other_analytes_unaffected_by_lift():
    ...
    labs_no_lift = derive_lab_values(_state(0.4), sex="M", age=60, hour=10, hai_inflammation_lift=0.0)
    labs_lifted = derive_lab_values(_state(0.4), sex="M", age=60, hour=10, hai_inflammation_lift=0.35)
