...
class TestGroupLabOrders:
    def test_cbc_full_panel_emits_one_group(self):
        ...
        from clinosim.modules.output.fhir_r4.builders.diagnostic_report import group_lab_orders
...
class TestBuildDrResource:
    def _group(self):
        from clinosim.modules.output.fhir_r4.builders.diagnostic_report import _GroupedPanel
    ...
    def test_shape_us(self):
        from clinosim.modules.output.fhir_r4.builders.diagnostic_report import build_dr_resource
...
class TestBuildLabPanelReports:
    ...
    def test_cbc_panel_emits_one_dr(self):
        from clinosim.modules.output.fhir_r4.builders.diagnostic_report import build_lab_panel_reports
